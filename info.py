...
PICS = (environ.get('PICS', 'https://telegra.ph/file/d982fefc077ad0ac0255f.jpg')).split()
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://kk71285631:KWuoAmrRouFPkTYB@cluster0.yvg41g8.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002612046146')).split()]
